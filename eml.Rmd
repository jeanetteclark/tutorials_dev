...
standard has a number of benefits. A metadata standard is a defined structure that allows information
...
All of this might sound confusing, and like it might not be any more helpful than unstructured metadata
like readme documents, but implementing a metadata standard has a number of advantages. Most of these
stem from the fact that the XML document created is machine readable - which enables a considerable amount
of functionality.

* Display
  - Render XML content on a [webpage](https://knb.ecoinformatics.org/view/doi:10.5063/F1NC5ZGW)
* Search
  - Discover datasets pertinent to your research interests
* Analyze
  - Semantic consistency of information allows for meta-analysis
